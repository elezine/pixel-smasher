...
# configurations
img_folder = '/home/ekaterina_lezine/esrgan_test_data/DIV2K/train_mod/LR/x4/*.png'  # glob matching pattern
lmdb_save_path = '/home/ekaterina_lezine/esrgan_test_data/DIV2K/train_mod/train_LR.lmdb'
