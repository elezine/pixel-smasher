...
cropped_folder = '/data_dir/classified_shield_v2/008_ESRGAN_x10_PLANET_noPreTrain_130k_Test_hold_shield_v2/visualization/Bic/x10/'
cropped_suffix = 'T0' #'008_ESRGAN_x10_PLANET_noPreTrain_130k_Test'

uncropped_folder = '/data_dir/Scenes-shield-gt/'

save_folder = '/data_dir/classified_shield_gt_georef/Bic/10x/'
